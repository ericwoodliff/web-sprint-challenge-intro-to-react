...
React JS is a framework primarily used to create user interfaces. It uses a virtual DOM which solves the problem of excessive DOM manipulation which can slow down an application and ruin the user interface. Moreover, React is based around reusable components which greatly reduce the amount of time needed to build applications. 

1. Describe component state.

An object that determines how our program functions in a given situation. 

1. Describe props.

Properties in React are arguments that are passed from parent to child components. 

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

A side effect is anything that affects objects outside of the function being executed. We sync effects in React by using the useEffect hook. 